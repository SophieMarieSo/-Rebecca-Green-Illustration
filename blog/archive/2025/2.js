export const detail = {
  ...
  content: [
    ...
    {
      type: "text",
      value: "If you make art, you know you must sometimes seek inspiration, for it does not always chase you down. I was determined to find a spark of creative joy towards this season, for my own sake, for art’s sake, for Sohvi’s - and after a few false starts, I did just that in the form of little painted treasures. What makes Autumn so particularly lovely is how short it is, how a flash of red is here and then gone before the long winter settles in. Witnessing the end of a life too, gives us this lightness - a reminder that it is all over, especially for some, too quickly. Nick Cave speaks of this so poetically after losing not one, but two sons.",
      tag: "p",
    },
    {
      type: "text",
      value: '"This feeling… of alertness to the inner-spirit of things — this humming — comes from a hard-earned understanding of the impermanence of things and, indeed, our own impermanence. This lesson ultimately animates and illuminates our lives. We become witnesses to the thrilling emergency of the present — a series of exquisite and burning moments, each extinguished as the next arises. These magical moments are the bright jewels of loss to which we cling". - Nick Cave',
      tag: "p",
    },
    {
      type: "text",
      value: "Bright jewels of loss. It's so bittersweet, I can hardly let it sink in without feeling everything. But also I’m ok feeling everything. The crushing weight of longing, the jealousy and unfairness of it all, the gratitude for everything I did get to experience, the acceptance and brilliance of each passing day.",
      tag: "p",
    },
    {
    ...
    {
      type: "text",
      value: "Cheers to this new season - to the end of Summer - to the magic of Autumn. It will be gone before we know it, so I’m here and ready to nestle in, get close up with the golden leaves, feel the crisp air against my skin and who knows, I might just find loads of inspiration once again.",
      tag: "p",
    },
    {
      type: "text",
